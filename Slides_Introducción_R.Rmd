...
## R Base y Paquetes
**R base**  
* Las funciones disponibles viven en el R HOME es el directorio donde R esta instalado. * Este directorio contiene paquetes de funciones.  
* **R Base** contiene las funciones básicas del lenguaje para leer y manipular datos, algunas funciones gráficas y algunas funciones estadísticas (regresión lineal y análisis de varianza).  
